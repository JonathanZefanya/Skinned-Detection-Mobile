...
class _ResultPageState extends State<ResultPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildResultPage(int index) {
      switch (index) {
        case 0:
          return DetailResultPage(
            ...
            lDetail:
                'Penyebab jerawat adalah penyumbatan pada pori-pori kulit. Penyumbatan ini dapat terjadi akibat produksi sebum berlebih oleh kelenjar minyak, penumpukan kulit mati, atau penumpukan bakteri.\n\n...',
            penyakit: 'Jerawat',
            tips: 'Beberapa upaya yang dapat dilakukan untuk mencegah jerawat yaitu\n\n...',
            medicine: [
              'assets/obat_jerawat1.png',
              'assets/obat_jerawat2.png',
              'assets/obat_jerawat3.png',
        ...
        case 1:
          return DetailResultPage(
            ...
            sDetail:
                'Penyebab kurap adalah jamur yang tumbuh dan berkembang biak dengan cepat pada kulit',
            lDetail: 'Penyebab kurap adalah jamur yang tumbuh dan berkembang biak dengan cepat pada kulit manusia.\n\n...',
            penyakit: 'Kurap',
            tips: 'Selain menggunakan obat anti jamur, pengidap dapat melakukan beberapa hal berikut ini untuk membantu mengatasi kurap:\n\n...',
            medicine: [
              'assets/obat_kurap1.png',
              'assets/obat_kurap2.png',
              'assets/obat_kurap3.png',
        ...
        case 2:
          return DetailResultPage(
            image: widget.image,
            sDetail: 'Penyebab scabies adalah tungau jenis S.scabiei yang menginvasi kulit. Tungau ini biasanya',
            lDetail: 'Penyebab scabies/kudis adalah tungau jenis S.scabiei yang menginvasi kulit.\n\n...',
            penyakit: 'Kudis',
            tips: 'Ada beberapa cara yang bisa dilakukan untuk mencegah infestasi ulang dan mencegah penyebaran penyakit ini pada orang lain, yaitu:\n\n...',
            medicine: [
              'assets/obat_kudis1.png',
              'assets/obat_kudis2.png',
              'assets/obat_kudis3.png',
        ...
        case 3:
          return DetailResultPage(
            image: widget.image,
            sDetail: 'Dermatitis disebabkan oleh zat yang mengiritasi kulit atau memicu reaksi alergi. Substansi',
            lDetail: 'Dermatitis disebabkan oleh zat yang mengiritasi kulit atau memicu reaksi alergi.\n\n...',
            penyakit: 'Dermatitis',
            tips: 'Berikut adalah beberapa upaya yang dapat dilakukan untuk mencegah dermatitis kontak:\n\n...',
            medicine: [
              'assets/obat_dermatitis1.png',
              'assets/obat_dermatitis2.png',
              'assets/obat_dermatitis3.png',
        ...
        case 4:
          return DetailResultPage(
            image: widget.image,
            sDetail: 'Pada umumnya, kutil disebabkan oleh infeksi virus dan jenis yang paling sering adalah human',
            lDetail: 'Pada umumnya, kutil disebabkan oleh infeksi virus dan jenis yang paling sering adalah human papilloma virus (HPV).\n\n...',
            penyakit: 'Kutil',
            tips: 'Ada beberapa cara yang dapat dilakukan untuk menurunkan risiko masalah kulit ini dan mencegah penyebarannya pada orang lain.\n\n...',
            medicine: [
              'assets/obat_kutil1.png',
              'assets/obat_kutil2.png',
              'assets/obat_kutil3.png',
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        appBar: customAppBar(),
        body: buildResultPage(label.indexOf(widget.pred![0]['label'])),
      ),
    );
  }
}
